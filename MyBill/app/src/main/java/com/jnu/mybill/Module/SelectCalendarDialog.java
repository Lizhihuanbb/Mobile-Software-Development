...
public class SelectCalendarDialog extends Dialog implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        hourEt = findViewById(R.id.dialog_calendar_et_hour);
        minuteEt = findViewById(R.id.dialog_calendar_et_minute);
        datePicker = findViewById(R.id.dialog_calendar_dp);
        ensureBtn = findViewById(R.id.dialog_calendar_btn_ensure);
        cancelBtn = findViewById(R.id.dialog_calendar_btn_cancel);
